...
final class App
{
    ...
    private function registerRoutes(Router $router): void
    {
        ...
        $router->match(['GET', 'POST'], '/messages/thread/{userId}', [MessageController::class, 'thread']);
        ...
        $router->post('/admin/users/{id}/verify', [AdminController::class, 'verifyUser']);
        ...
        $router->match(['GET', 'POST'], '/admin/messages/thread/{userAId}/{userBId}', [AdminController::class, 'messageThread']);
        $router->match(['GET', 'POST'], '/admin/messages/broadcast', [AdminController::class, 'broadcastMessages']);
        ...
        $router->match(['GET', 'POST'], '/admin/integrations', [AdminController::class, 'integrations']);
