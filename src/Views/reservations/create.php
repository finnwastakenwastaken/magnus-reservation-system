    ...
    <div class="col-lg-6">
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                <h1 class="h3 mb-4"><?= htmlspecialchars($translator->get('reservation.create'), ENT_QUOTES, 'UTF-8') ?></h1>
                <form method="post">
                    ...
                    <button class="btn btn-primary" type="submit"><?= htmlspecialchars($translator->get('reservation.create'), ENT_QUOTES, 'UTF-8') ?></button>
                </form>
            </div>
        </div>
    </div>
