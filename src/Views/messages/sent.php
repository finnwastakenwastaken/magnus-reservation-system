...
<div class="card shadow-sm border-0">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h1 class="h3 mb-0"><?= htmlspecialchars($translator->get('messages.sent'), ENT_QUOTES, 'UTF-8') ?></h1>
                    ...
                    <div class="list-group-item px-0">
                        <div class="d-flex justify-content-between gap-3 flex-wrap">
                            <div>
                                ...
                                <div class="small text-secondary"><?= htmlspecialchars($message['recipient_first_name'] . ' ' . strtoupper(substr($message['recipient_last_name'], 0, 1)) . '.', ENT_QUOTES, 'UTF-8') ?></div>
                            </div>
